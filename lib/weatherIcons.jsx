 ...
 */
export function createWeatherIcon(weatherCode, isDay, props = {}) {
 ...
 */
export function createMainWeatherIcon(weatherCode, isDay, props = {}) {
  return createWeatherIcon(weatherCode, isDay, {
    pixelSize: 30,
    cssClasses: ["main-icon", ...(props.cssClasses ?? [])],
    vexpand: false,
 ...
 */
export function createSmallWeatherIcon(weatherCode, isDay, props = {}) {
  return createWeatherIcon(weatherCode, isDay, {
    pixelSize: 16,
    cssClasses: ["small-icon", ...(props.cssClasses ?? [])],
    ...props,
  });
}
 ...
 */
export function createWeatherIconDebug() {
